...
fn detector_tracks_candidates() {
    ...
    d.submit(CycleCandidate {
        object: ColoredPtr::new(0x1000, crate::xgc::colored::Color::White),
        weak_ref: 1,
    });
    d.submit(CycleCandidate {
        object: ColoredPtr::new(0x2000, crate::xgc::colored::Color::White),
        weak_ref: 2,
    });
...
fn dfs_threshold_triggers() {
    ...
    for i in 0..10usize {
        d.submit(CycleCandidate {
            object: ColoredPtr::new(i, crate::xgc::colored::Color::White),
            weak_ref: i as u32,
        });
    }
    assert!(d.should_dfs());
